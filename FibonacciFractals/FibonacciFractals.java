...
public class FibonacciFractals extends JPanel implements ComponentListener,MouseWheelListener{
	...
	public static int iterations(Complex c){
		  double escape = 10E100;
		  Complex z = new Complex(c.re(),c.im());
		  int i=0;
		  while(i<20 && z.abs()<=escape){
		   i++;
		   Complex ztemp = FibFun.multipleFormula(z);
		   z = ztemp;
		  }
		  return i;
	}
	...
	public static void main(String[] args){
		...
		FibonacciFractals p = new FibonacciFractals();
